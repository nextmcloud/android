...
class OCFileListDelegate(
    ...
    fun bindViewHolder(
        ...
        if (shouldHideShare) {
            ...
            viewHolder.sharedMessage?.visibility = View.GONE
        } else {
            showShareIcon(viewHolder, file)
        }
    ...
    private fun showShareIcon(gridViewHolder: ListViewHolder, file: OCFile) {
        ...
        sharedMessageView?.visibility =
            if (com.nmc.android.utils.DisplayUtils.isShowDividerForList(context)) View.VISIBLE else View.GONE
