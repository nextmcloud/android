...
open class FolderPickerActivity :
    ...
    private fun refreshListOfFilesFragment(directory: OCFile?) {
        listOfFilesFragment?.listDirectoryFolder(directory, false, mShowOnlyFolder, mHideEncryptedFolder)
    }
    ...
    private fun adjustButtonTexts(){
        if (!com.nmc.android.utils.DisplayUtils.isTablet(this)
            && !com.nmc.android.utils.DisplayUtils.isLandscapeOrientation(this)
        ) {
