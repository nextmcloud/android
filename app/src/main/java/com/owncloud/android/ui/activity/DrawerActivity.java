...
public abstract class DrawerActivity extends ToolbarActivity
    ...
    private void setQuotaInformation(long usedSpace, long totalSpace, int relative, long quotaValue) {
        ...
        mQuotaTextUsage.setText(StringUtils.makeTextBold(usageText, HumanReadableFormatter.formatBytes(usedSpace)));
    ...
    public void showBottomNavigationBar(boolean show) {
        // NMC Customization: always hide bottom bar
        ViewExtensionsKt.setVisibleIf(bottomNavigationView, false);
    }
