...
class OnBoardingUtils {
    ...
    companion object {
        ...
        fun getOnBoardingItems(context: Context): List<FeatureItem> {
            val onBoardingItems = mutableListOf<FeatureItem>()
            val onBoardingImages = getOnBoardingImages(context)
        ...
        private fun getOnBoardingImages(context: Context): Array<Int> {
            return if (com.nmc.android.utils.DisplayUtils.isTablet(context)) {
                if (com.nmc.android.utils.DisplayUtils.isLandscapeOrientation(context)) {
                    TAB_LAND_IMAGES
                } else {
                    TAB_PORT_IMAGES
                }
