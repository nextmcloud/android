...
public class SaveScannedDocumentFragment extends Fragment implements CompoundButton.OnCheckedChangeListener,
    ...
    private void initViews() {
        ...
        CheckableThemeUtils.tintSwitch(binding.scanSavePdfPasswordSwitch);
        CheckableThemeUtils.tintCheckbox(binding.scanSaveWithoutTxtRecognitionPdfCheckbox,
        ...
        binding.scanSavePdfPasswordTextInput.setDefaultHintTextColor(new ColorStateList(
            ...
            new int[]{
                Color.GRAY,
                getResources().getColor(R.color.text_color, null)
            }
        ));
    }
