...
// edit polygon view: https://github.com/doo/scanbot-sdk-example-android/tree/master/classic-components-example/edit-polygon-view
                    ...
                    return when (menuItem.itemId) {
                        R.id.action_save -> {
                            ...
                            if (fragment is ScanPagerFragment) {
                                ...
                                if (fragment.filteringState == ScanPagerFragment.FilteringState.IDLE) {
                                    saveScannedDocs()
                                }
                            } else {
                                saveScannedDocs()
