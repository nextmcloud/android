...
class ConflictsResolveConsentDialogIT : AbstractIT() {
    ...
    fun replaceWithNewFile() {
        ...
        val dialog = ConflictResolveDialogFactory.forNormal(
        ...
        sut.listener =
            ConflictsResolveDialog.OnConflictDecisionMadeListener { decision: ConflictsResolveDialog.Decision? ->
                Assert.assertEquals(decision, ConflictsResolveDialog.Decision.KEEP_LOCAL)
                returnCode = true
            }
    ...
    fun keepBothFiles() {
        ...
        sut.listener =
            ConflictsResolveDialog.OnConflictDecisionMadeListener { decision: ConflictsResolveDialog.Decision? ->
                Assert.assertEquals(decision, ConflictsResolveDialog.Decision.KEEP_BOTH)
                returnCode = true
            }
    ...
    fun keepExistingFile() {
        ...
        sut.listener =
            ConflictsResolveDialog.OnConflictDecisionMadeListener { decision: ConflictsResolveDialog.Decision? ->
                Assert.assertEquals(decision, ConflictsResolveDialog.Decision.KEEP_SERVER)
                returnCode = true
            }
