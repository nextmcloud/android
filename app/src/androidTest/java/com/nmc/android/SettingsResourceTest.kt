...
class SettingsResourceTest {
    ...
    private val localizedStringMap = mapOf(
        ...
        R.string.prefs_rating to ExpectedLocalizedString(
            translations = mapOf(
                Locale.ENGLISH to "Rate the app",
                Locale.GERMAN to "Ihre Bewertung"
            )
        ),
        R.string.prefs_rating_summary to ExpectedLocalizedString(
            translations = mapOf(
                Locale.ENGLISH to "Are you satisfied with our app? Please give us your feedback!",
                Locale.GERMAN to "Sind sie zufrieden mit unserer App? Geben Sie uns bitte Ihr Feedback!"
            )
        ),
